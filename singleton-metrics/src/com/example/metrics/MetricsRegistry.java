...
public class MetricsRegistry implements Serializable {
    ...
    private static volatile MetricsRegistry INSTANCE; // Made it volatile - thread safe
    // Without volatile, one thread may update its CPU cache with the new object reference, 
    // while other threads still see null
    ...
    private MetricsRegistry() {
        // Blocks reflection
        if(INSTANCE != null){
            throw new RuntimeException("Reflection Blocked!");
        }
    }
...
// * CURRENT STATE (BROKEN ON PURPOSE):
// * - Constructor is public -> anyone can create instances.
// * - getInstance() is lazy but NOT thread-safe -> can create multiple
// instances.
// * - Reflection can call the constructor to create more instances.
// * - Serialization can create a new instance when deserialized.
// *
